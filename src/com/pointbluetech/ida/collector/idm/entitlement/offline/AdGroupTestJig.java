...
customQueryParam.put("value", "");
            ...
            JSONObject request = new JSONObject("{\n" +
                    "  \"search-class\": \"permission\",\n" +
                    "  \"view-dxml-search-class\": \"Group\",\n" +
                    "  \"view-custom-query\": \"<nds dtdversion=\\\"2.0\\\">      <input>          <query class-name=\\\"Group\\\" event-id=\\\"ENTITLEMENT:Group\\\" scope=\\\"subtree\\\" subscriber-type=\\\"service\\\">              <search-class class-name=\\\"Group\\\"\\/>              <read-attr attr-name=\\\"Description\\\"\\/>   <read-attr attr-name=\\\"managedBy\\\"\\/>            <read-attr attr-name=\\\"member\\\"\\/>             <read-attr attr-name=\\\"CN\\\"\\/>             <read-attr attr-name=\\\"sAMAccountName\\\"\\/>             <operation-data ig-collection-query=\\\"true\\\"\\/>         <\\/query>      <\\/input>  <\\/nds>\",\n" +
                    "  \"read-attrs\": [\n" +
                    "    \"association\",\n" +
                    "    \"id2\",\n" +
                    "    \"liid\",\n" +
                    ...
                    "  \"idm-attribute-for-association\": \"Member\",\n" +
                    "  \"view-name\": \"permission\"\n" +
                    "}");
