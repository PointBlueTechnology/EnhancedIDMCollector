...
public class TestJig extends BaseTestJig {

    public static void main(String[] args) {
        TestJig theOne = new TestJig();
        theOne.run();
    }
    ...
    public void run() {
        ...
        try {
            ...
            JSONObject configData = getJSONDoc("/com/pointbluetech/ida/collector/idm/entitlement/offline/testjig-config.json");
            ...
            JSONObject request = getJSONDoc("/com/pointbluetech/ida/collector/idm/entitlement/offline/testjig-request.json");
