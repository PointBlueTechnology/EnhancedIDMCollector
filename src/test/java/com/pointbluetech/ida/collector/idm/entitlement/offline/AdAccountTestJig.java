...
public class AdAccountTestJig extends BaseTestJig {
    ...
    public void run() {
        ...
        try {
            ...
            JSONObject configData = getJSONDoc("/com/pointbluetech/ida/collector/idm/entitlement/offline/adaccount-config.json");
            ...
            JSONObject request = getJSONDoc("/com/pointbluetech/ida/collector/idm/entitlement/offline/adaccount-request.json");
